...
public class Customer {
    ...
    public void setLawReposibility(String lawReposibility) {
        this.lawReposibility = lawReposibility == null ? null : lawReposibility.trim();
    }
    ...
    public void setIsUseFinanceSoft(String isUseFinanceSoft) {
        this.isUseFinanceSoft = isUseFinanceSoft == null ? null : isUseFinanceSoft.trim();
    }
    ...
    public void setInvestigateBy(String investigateBy) {
        this.investigateBy = investigateBy == null ? null : investigateBy.trim();
    }
